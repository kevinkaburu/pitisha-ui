...
@section('content')
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="card card-stats">
                        <div class="card-header card-header-success card-header-icon">
                            ...
                            <h3 class="card-title">Your Bank </h3>
                        </div>
                        <div class="card-footer">
                            @if(is_null($userBank))
                                <div style="text-align: center;">
                                    <div class="alert alert-info">Please provide your bank details to withdraw from PayPal to bank</div>
                                </div>
                            @else
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#withdrawBank"
    ...
    <div id="withdrawBank" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header" style="display: inline">
                    ...
                    <h4  style="text-align: center;" class="modal-title">Withdraw from Paypal to your Bank</h4>
                </div>
...
@section('scripts')
    ...
    <script>
        ...
        function verify_payment(orderID){
            $.ajax({
                url: '/withdraw/paypal/bank/verify/' + orderID,
                type: 'get',
                headers: {
