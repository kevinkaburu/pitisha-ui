                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('password.update') }}">
                                ...
                                <div class="form-group row">
                                    <label for="email" class="col-md-4  offset-md-3 col-form-label text-md-left">{{ __('E-Mail Address') }}</label>
                                ...
                                <div class="form-group row">
                                    <label for="password" class="col-md-4  offset-md-3 col-form-label text-md-left">{{ __('Password') }}</label>
                                ...
                                <div class="form-group row">
                                    <label for="password-confirm" class="col-md-4  offset-md-3 col-form-label text-md-left">{{ __('Confirm Password') }}</label>
